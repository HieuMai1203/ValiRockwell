        ...
        if(len > 0){
            for(var i=0;i<len;i++){
                    txt += "<tr><td>"+data[i].date_time
                        +"</td><td>"+data[i].data_Billet
                        +"</td><td>"+data[i].data_Hole
                        +"</td></tr>";
                    }
            if(txt != ""){
            txt +="</tbody>"; 
            $("#table_History").append(txt);
            }
        }
    }   
}
...
{
    var val = [document.getElementById('History_Search_Start').value,
               document.getElementById('History_Search_End').value];
