...
{
    document.getElementById(scr_1).style.display = 'inline';   
...
function fn_SymbolStatusBillet(ObjectID, SymName, Tag)
{

    var imglink_0 = "images/BilletDrill/" + SymName + "_0.png" ; // Trạng thái tag = 0
    var imglink_1 = "images/BilletDrill/" + SymName + "_1.png" ; // Trạng thái tag = 1
